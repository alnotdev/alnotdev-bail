...
console.log(
  chalk.hex('#d7a1ff').italic('     L A V E N D O Z  B A I L E Y S   \n') +
  chalk.hex('#a78bfa').italic('           V6  B A I L E Y S\n\n') +
  chalk.hex('#89CFF0').italic('     last updated • 15 February 2026\n') +
  chalk.hex('#c084fc').italic('     Created by @alnotdev\n') +
  chalk.hex('#a78bfa').italic('           telegram: @alnotdev\n\n') +
